                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mt-0 header-title mb-4">
                                Batch - List
                                <a href="{{ route('batches.create') }}" class="btn btn-sm btn-primary float-end">Add New</a>
                            </div>
                                ...
                                @foreach($batches as $batch)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center{{ $batch->id }}">Delete
                                            </button>
                                        </td>
                                    </tr>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    {!! Form::close() !!}
                                                    <button type="button" class="btn btn-lg btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center{{$batch->id}}"> No </button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
