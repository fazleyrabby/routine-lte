                                    ...
                                    @foreach($shifts as $shift)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target=".bs-example-modal-center{{$shift->id}}">Delete</button>
                                            </td>
                                        </tr>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        {!! Form::close() !!}
                                                        <button type="button" class="btn btn-lg btn-primary waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-center{{$shift->id}}"> No </button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
