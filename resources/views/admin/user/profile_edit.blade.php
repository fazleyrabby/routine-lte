                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {!! Form::open( ['route' => ['users.update', $user->user_id], 'method'=>'put','enctype'=> 'multipart/form-data'])!!}
                            <div class="row">
                                <div class="col-md-4">
                            ...
                            @else
                                ...
                                <h4 class="text-danger text-center p-4"> Sorry you don't have access on this page! </h4>
